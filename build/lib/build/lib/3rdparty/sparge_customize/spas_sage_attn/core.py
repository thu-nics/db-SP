...
@torch.compiler.disable
def customize_spas_sage_attn_meansim_cuda(q, k, v, attn_mask=None, dropout_p=0.0, is_causal=False, scale=None, smooth_k=True, simthreshd1=0.1, cdfthreshd=0.9, pvthreshd=20, attention_sink=False, tensor_layout="HND", output_dtype=torch.float16, return_sparsity=False, return_lut = False):
    ...
    if return_lut:
        ...
        head_density = valid_block_num.squeeze(0).sum(dim=-1)
        return o, head_density 
    else:
        return o
